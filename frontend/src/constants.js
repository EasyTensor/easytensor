...
export const REPORTER_PROTOCOL = `${process.env.REACT_APP_REPORTER_HTTP_SERVER_PROTOCOL}`;
export const REPORTER_WEBSOCKET_PROTOCOL = `${process.env.REACT_APP_REPORTER_WEBSOCKER_SERVER_PROTOCOL}`;
...
export const REPORTER_WEBSOCKET_URL = `${REPORTER_WEBSOCKET_PROTOCOL}://${REPORTER_ADDRESS}:${REPORTER_PORT}`;
